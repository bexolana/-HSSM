                                ...
                                <form action="https://SmmPortal.com/course/categories/store" method="POST" id="category-form" name="category-form" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label" for="nameInput">Bank Name
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label" for="nameInput">Bank Number
                                                            <strong class="text-danger">*</strong></label>
                                                        <input name="Number" id="nameInput" class="primary_input_field name " placeholder="Number" type="text" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-15">
                                                <div class="primary_input single-uploader">
                                                    ...
                                                    <p class="image_size">Recommended size 160px x 160px</p>
                                             </div>
                                            </div>
                                        </div>
                                            <div class="row">
