...
<body class="admin">
<input type="hidden" name="url" id="url" value="https://SmmPlan.com">
        ...
        <section class="sms-breadcrumb mb-10 white-box">
                <div class="container-fluid p-0">
                    <div class="d-flex flex-wrap justify-content-between">
                        <h1 class="text-uppercase">Role and Permission</h1>
                        <div class="bc-pages">
                            <a href="/dashboard">Dashboard</a>
                            <a href="/role">Role and Permission</a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="modal fade" id="item_add">
                        <div class="modal-dialog modal_800px modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form enctype="multipart/form-data"  method="POST" action="{{ route('roles.create') }}">       
                                    @csrf
                                                                     <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for="">Role Name <span class="required_mark">*</span></label>
                                                    <input name="name" class="primary_input_field name" id="name" placeholder="Role Name" type="text" required="1">
                                                    <span class="text-danger" id="name_error"></span>
                                                </div>

                                                <div class="row" id="RoleCheckbox">
    @foreach($permissions as $permission)
        <div class="col-12 mb-25">
            <label class="primary_checkbox d-flex mr-12 w-max">
                ...
                <span class="checkmark me-2"></span> {{ $permission->name }}
            </label>
        </div>
    @endforeach
</div>
                            ...
                            <div class="col-12">
                                <div class="box_header common_table_header">
                                    <div class="main-title d-md-flex">
                                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">Role List</h3>
                                        <ul class="d-flex">
                                            <li>
                                                <button class="primary-btn radius_30px   fix-gr-bg"
                                                    onclick="createModalShow()"><i class="ti-plus"></i>Add New Role
                                                </button>
                                            </li>
                                        </ul>
            ...
            <tr>
                ...
                <td>
                    <!-- Assuming you have a status field, adjust accordingly -->
                    {{ $role->status ?? 'Active' }}
                </td>
                <td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="row" id="RoleCheckbox">
                                            <div class="col-12 mb-25">
                                                <label class="primary_checkbox d-flex mr-12 w-max ">
                                                    <input type="checkbox" id="for_role" class="forRole"name="for_role" value="Role">
                                                    <span class="checkmark me-2"></span> Role_1
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" id="RoleCheckbox">
                                            <div class="col-12 mb-25">
                                                <label class="primary_checkbox d-flex mr-12 w-max ">
                                                    <input type="checkbox" id="for_role" class="forRole"name="for_role" value="Role">
                                                    <span class="checkmark me-2"></span> Role_2
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" id="RoleCheckbox">
                                            <div class="col-12 mb-25">
                                                <label class="primary_checkbox d-flex mr-12 w-max ">
                                                    <input type="checkbox" id="for_role" class="forRole"name="for_role" value="Role">
                                                    <span class="checkmark me-2"></span> Role_3
                                                </label>
                                            </div>
                                        </div>
                                            </div>
